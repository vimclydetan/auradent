...
namespace App\Controllers\Receptionist; // Idinagdag ang \Receptionist dito para tumugma sa folder
...
class CalendarController extends BaseController
{
    ...
    public function index()
    {
        ...
        // Siguraduhin na ang view file ay nasa: app/Views/receptionist/calendar/index.php
        return view('receptionist/calendar/index', $data);
    }
    ...
    public function getEvents()
    {
        ...
        $appointments = $apptModel->select('appointments.*, patients.last_name as p_last, patients.first_name as p_first, dentists.last_name as d_last')
            ...
            ->whereIn('appointments.status', ['Pending', 'Confirmed', 'Cancelled'])
            ->findAll();
