<?php
/**
 * Email Template: Appointment Confirmed
 * 
 * Payload variables (from controller/DB):
 *   $patient_name, $queue_number, $appointment_date, $appointment_time,
 *   $dentist_name, $patient_code
 * 
 * Clinic data: Automatically loaded from Config\Clinic (with env() fallbacks)
 */

// 📦 Load email helper for format_phone_for_link()
helper('email');

// 🏥 Load clinic config — may built-in defaults na via env()
$clinic = config('Clinic');

// 👤 Appointment-specific variables (with fallbacks for safety)
...
// 🏢 Clinic data — DIRECTLY from Config\Clinic (NO fallbacks needed)
...
<head>
    ...
    <title>Appointment Confirmed - <?= esc($clinic_name) ?></title>
</head>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
                ...
                <tr>
                    <td style="background-color:#16a34a;padding:14px 40px;text-align:center;">
                        <p style="margin:0;color:#ffffff;font-size:14px;font-weight:700;letter-spacing:1px;text-transform:uppercase;">Appointment Confirmed</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="background-color:#ffffff;padding:36px 40px;">
                        ...
                        <p style="margin:0 0 28px 0;color:#475569;font-size:14px;line-height:1.6;">
                            Your appointment at <strong><?= esc($clinic_name) ?></strong> has been confirmed.
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:6px;margin-bottom:28px;">
                            ...
                            <tr>
                                <td style="padding:12px 20px;color:#64748b;font-size:13px;border-bottom:1px solid #f1f5f9;">Date</td>
                            ...
                            <tr>
                                <td style="padding:12px 20px;color:#64748b;font-size:13px;border-bottom:1px solid #f1f5f9;">Time</td>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#fefce8;border:1px solid #fde68a;border-radius:6px;margin-bottom:28px;">
                            <tr>
                                <td style="padding:16px 20px;">
                                    <p style="margin:0 0 10px 0;color:#78350f;font-size:12px;font-weight:700;letter-spacing:1px;text-transform:uppercase;">Before Your Visit</p>
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <?php
                                        $reminders = [
                                            'Arrive 10 to 15 minutes before your scheduled time.',
                                            'Bring a valid ID and your queue number.',
                                        ...
                                        <tr>
                                            <td style="padding:3px 0;color:#92400e;font-size:13px;line-height:1.5;">
                                                <!-- ✅ Replaced em-dash with bullet per preference -->
